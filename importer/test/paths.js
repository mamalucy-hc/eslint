...
describe('paths', function () {
  ...
  it(`should resolve a file in a local meteor package`, function () {
    expect(meteorResolver.resolve('meteor/foo/bar.js', replaceSlashWithPathSep('./test/imports/package-test/plain-file.js')))
      .to.have.property('found', true)
  })
